                    ...
                    <div className="content-wrapper">
                        ...
                        <div className="h1-container">
                            <h1>Greetings, Earthling. <br />
                                <span>I'm Charlotte Soumeillan!</span></h1>
                            <br /><br />
                    ...
                    <section id="about">
                        <div className="content-wrapper">
                            ...
                            <div className="about-me-blurb">
                                ...
                                <h4><i className="fa-solid fa-laptop-code"></i>  Web Developer</h4>
                                ...
                                <div className="resume-buttons">
                                    <Link to="resume" target="_blank">Check out my resume!</Link>
                                </div>
                                <div className="resume-buttons">
                                    <a href="/docs/Charlotte-S-Web-Developer-Resume.pdf" download="Charlotte-S-Web-Developer-Resume.pdf" target="_blank">Or download it, that's fine too</a>
                                </div>
                            </div>
